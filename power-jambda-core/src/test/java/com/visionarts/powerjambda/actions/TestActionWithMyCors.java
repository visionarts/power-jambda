 ...
 * <br>
 */
@Route(resourcePath = "/test_action_with_mycors", methods = HttpMethod.GET, cors = TestActionWithMyCors.MyCors.class)
public class TestActionWithMyCors extends AbstractLambdaAction<EmptyActionBody, String> {

    public static class MyCors implements CorsConfiguration {
        @Override
