 ...
 * <br>
 */
public class TestActionAlwaysOccurException extends AbstractEventAction<TestAction1Body> {
    ...
    @Override
    protected void handleEvent(EventActionRequest<TestAction1Body> request, Context context)
            throws InternalErrorException {
        throw new InternalErrorException("Occurs Exception");
    }
}
